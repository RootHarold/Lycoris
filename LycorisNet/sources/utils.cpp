...
namespace LycorisNet {
    ...
    uint32_t LycorisUtils::sort1(Individual &in, std::vector<float> &ret1, std::vector<uint32_t> &ret2) {
    ...
    uint32_t LycorisUtils::sort2(Individual &in, std::vector<Gen> &ret1, std::vector<Ome> &ret2) {
        std::vector<bool> temp1(in.innovationNum, false);
    ...
    float LycorisUtils::distance(LycorisNet::Individual &in1, LycorisNet::Individual &in2) {
        float d;
        uint32_t DE = 0;
        std::vector<float> w1;
    ...
    Individual *LycorisUtils::mateIndividual(LycorisNet::Individual &in1, LycorisNet::Individual &in2) {
